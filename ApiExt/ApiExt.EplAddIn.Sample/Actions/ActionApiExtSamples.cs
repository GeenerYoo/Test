...
using ApiExt.EplAddIn.Sample.Forms;
...
namespace ApiExt.EplAddIn.Sample.Actions
{
    ...
    /// </summary>
    public class ActionApiExtSamples : IEplAction
    {
        /// <summary>
        ...
        public void GetActionProperties(ref ActionProperties actionProperties)
        {
            ...
            // firstParam.set("Param1", "1. Parameter for ActionApiExtSamples"); 
            // actionProperties.addParameter(firstParam);

            // Description 2nd parameter
            // ActionParameterProperties firstParam= new ActionParameterProperties();
            // firstParam.set("Param2", "2. Parameter for ActionApiExtSamples"); 
            // actionProperties.addParameter(firstParam);
