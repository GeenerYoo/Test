...
namespace Addin_Test
{
    ...
    /// </summary>
    public class ActionPopupChildMenu1 : IEplAction
    {
        /// <summary>
        ...
        public bool Execute(ActionCallingContext ctx)
        {
            ...
            MessageBox.Show("ChildMenu Check!!");
            return true;
        }
        /// <summary>
        ...
        public void GetActionProperties(ref ActionProperties actionProperties)
        {
            ...
            // firstParam.set("Param1", "1. Parameter for ActionPopupChildMenu1"); 
            // actionProperties.addParameter(firstParam);

            // Description 2nd parameter
            // ActionParameterProperties firstParam= new ActionParameterProperties();
            // firstParam.set("Param2", "2. Parameter for ActionPopupChildMenu1"); 
            // actionProperties.addParameter(firstParam);
